...
class Vehicle(object):
    ...
    def __init__(self, wheels: int, occupants: int, color: str):
        self.wheels = wheels
...
class Vehicle(object):
    ...
    def add_n_occupants(self, occupants_to_add):
        if self.occ + occupants_to_add <= self.max_occupancy:
            self.occ += occupants_to_add
            return self.occ
        else:
            return ValueError(f"Maxximum occupancy: {self.max_occupancy}")
